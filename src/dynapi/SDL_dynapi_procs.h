...
SDL_DYNAPI_PROC(SDL_GPUComputePipeline*,SDL_CreateGPUComputePipelineWithResourceLayout,(SDL_GPUDevice *a,const SDL_GPUComputePipelineWithResourceLayoutCreateInfo *b),(a,b),return)
SDL_DYNAPI_PROC(SDL_GPUShader*,SDL_CreateGPUShaderWithResourceLayout,(SDL_GPUDevice *a,const SDL_GPUShaderWithResourceLayoutCreateInfo *b),(a,b),return)
